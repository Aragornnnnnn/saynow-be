...
개발 서버 Swagger/OpenAPI server URL은 현재 active dev 도메인인 `https://saynow.p-e.kr`입니다.
dev 프로필은 `/saynow/develop/SAYNOW_OPENAPI_SERVER_URL`에 이전 개발 도메인 `https://dev-saynow.p-e.kr`이 남아 있어도 현재 active dev 도메인으로 보정합니다.
