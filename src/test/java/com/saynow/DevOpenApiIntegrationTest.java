...
@ActiveProfiles("dev")
@TestPropertySource(properties = "saynow.openapi.server-url=https://saynow.p-e.kr")
class DevOpenApiIntegrationTest extends IntegrationTestSupport {
    ...
    @Test
    void devProfileExposesDevelopServerUrlEvenWhenProdUrlIsInjected() throws Exception {
