...
class OpenApiIntegrationTest extends IntegrationTestSupport {
    ...
    void separatesSuccessAndErrorResponsesPerApi() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/categories/{categoryId}/scenarios'].get.responses.200").exists())
                .andExpect(jsonPath("$.paths['/api/v1/categories/{categoryId}/scenarios'].get.responses.404.content['application/json'].examples.CATEGORY_NOT_FOUND.value.error.code").value("CATEGORY_NOT_FOUND"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/sessions/{sessionId}/metrics/micReady'].put.responses.409.content['application/json'].examples.SESSION_ALREADY_ENDED.value.error.code").value("SESSION_ALREADY_ENDED"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/sessions/{sessionId}/feedback'].get.responses.202.content['application/json'].examples.FEEDBACK_GENERATING.value.error.code").value("FEEDBACK_GENERATING"))
